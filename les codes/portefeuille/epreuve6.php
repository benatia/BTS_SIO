...
?>
        <form method="post" action="epreuve6.php">
...
?>
			...
			<h1>EPREUVE VI</h1>
			    ...
			    <h2>Contexte de travail</h2> 
					<p> La situation professionnelle consiste à mettre 
					en place une application web qui permet la présentation  de l'épreuve E6 ,le Jury peut utiliser
					cette application pour consulter mes travaux en ligne.
					</p>
				<h2>Description fonctionnelle </h2>
					<p>Jury : 
					possibilité de consulter et télécharger mes travaux .<br/> 
					Étudiant:
					possibilité de consulter ,modifier ,supprimer  sur mon site .
					</p>
				<h2>Description technique </h2>
					<p>Pour réaliser cette application j'ai utilisé comme langages 
					HTML CSS JQUERY AJAX et PHP et pour la base de données j'ai utilisé MYSQL
                    En ce qui concerne le matériel:un ordinateur et un serveur virtuel </p>
			    <h2>Période:</h2> 
					<p> durant la 2ème année BTS .</p>*
			...
			<p>https://www.youtube.com/watch?v=hMxGhHNOkCU</p>
			
			<h2>Conclusion</h2>
				<p>Cette Application m'a poussé à découvrir un autre langage
				AJAX et à acquérir des nouveaux notions .
				</p>
